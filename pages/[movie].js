    ...
    return (
        <div>
            <Head>
                ...
                <meta
                    name="keywords"
                    content={`${item.name},watch online ${item.name},download ${item.name}, , e4a, E4A, entertainment4all, e4a live, entertainment4all live, download movies,download webseries,download anime,  watch movies online,watch anime online, match webseries online`}
                />
                    ...
                    <Stack sx={{ backgroundImage: setbg(), backgroundSize: 'cover', backgroundPosition: 'center', overflowX: 'hidden' }}>
                        <Stack sx={{ background: 'rgba(0,0,0,0.8)' }}>
                            ...
                            <Stack direction="row" sx={{ margin: { xs: '0px', md: '0px 50px', lg: '0px 150px' }, gap: '20px', display: { xs: 'none', md: 'flex' } }}>
                                <Stack sx={{ flex: { md: 2, lg: 1 } }}><img src={item.image} alt="" style={{ maxWidth: '100%' }} /></Stack>
                                <Stack sx={{ flex: 5 }}>
                                    ...
                                    <Stack direction="row" sx={{ justifyContent: 'space-between' }}>
                                        <Stack direction="row" sx={{ gap: '5px', color: 'white' }}>
                                            ...
                                            <Typography sx={{}}>{item.genera}</Typography>
                                        </Stack>
                            ...
                            <Stack sx={{ display: { xs: 'flex', md: 'none' }, margin: '0px 20px' }}>
                                <Stack direction="row" sx={{ gap: '10px' }}>
                                    <Stack sx={{ flex: 1 }}><img src={item.image} alt="" style={{ maxWidth: '100%' }} /></Stack>
                                    <Stack sx={{ flex: 3, '& p': { fontSize: { xs: '0.7rem', sm: '1rem' } } }}>
